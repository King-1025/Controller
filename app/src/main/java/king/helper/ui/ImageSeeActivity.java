...
import king.helper.view.ImageAdapter;
import king.helper.R;

public class ImageSeeActivity extends BasedActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener,ViewSwitcher.ViewFactory{
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        back= (Button) findViewById(R.id.activityimageseeButtonBack);
        delete= (Button) findViewById(R.id.activityimageseeButtonDeleteImage);
    ...
    public void onClick(View v) {
        int id=v.getId();
        switch (id){
            case R.id.activityimageseeButtonBack:
                skipToActivity(SettingActivity.class,true);
                break;
            case R.id.activityimageseeButtonDeleteImage:
